...
public class Base
{
    ...
    { return getBasicRequest().body(body).post().then(); }
    
    
    public ValidatableResponse listTriangles()
    ...
    private static class DeletionThread extends Thread {
        String id;
        DeletionThread(String id)
        { this.id = id; }
    ...
    public void cleanUp()
    {
        ...
        {
            ValidatableResponse deletedTriangle = deleteTriangle(triangle.id);
        }
    }
}
